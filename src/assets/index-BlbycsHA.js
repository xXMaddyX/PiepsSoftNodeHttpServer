...
`;class z extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){this.shadow.innerHTML=P,this.addRedirectToPortfolios()}addRedirectToPortfolios(){this.shadow.querySelectorAll(".team-card").forEach(o=>{let i=o.getAttribute("linkData");o.addEventListener("click",()=>{window.open(i,"_blank")})})}}const H=`
<div id="container">
